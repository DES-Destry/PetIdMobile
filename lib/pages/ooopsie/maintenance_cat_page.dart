...
class MaintenanceCatPage extends StatelessWidget {
  const MaintenanceCatPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        Positioned.fill(
          child: Image.asset(Paths.getImage('maintenance-cat.png'),
              fit: BoxFit.cover),
        ),
        Column(
                ...
                child: Column(
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            'ooopsie.maintenanceDescription'.tr(),
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          Text('ooopsie.estimatedTimeLeft'.tr(),
                              style: TextStyle(
